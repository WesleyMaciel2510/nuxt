<template>
  <div :class="[openModal ? 'fixed flex' : 'hidden', 'modal']">
    ...
    <div class="modal-wrapper">
      <div
        class="bg-grey_light flex items-center justify-between rounded-t-2xl p-5"
      >
        ...
        <section class="p-5 rounded-b-2xl">
          <div v-if="!isUserSignedUp">
            ...
            <div class="m-4">
              <input
                :class="[
                  highlightEmailWithError ? 'input border-red' : 'input',
                ]"
                type="email"
            ...
            <div class="m-4">
              <input
                :class="[
                  highlightPasswordWithError ? 'input border-red' : 'input',
                ]"
                type="password"
                placeholder="********"
                v-model="password"
